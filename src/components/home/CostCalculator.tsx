                  ...
                  <div className="flex p-1 bg-black/20 rounded-xl overflow-x-auto scrollbar-none">
                    {CATEGORIES.map((cat) => (
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 flex-1 px-4 py-2.5 rounded-lg text-[9px] font-black uppercase tracking-widest transition-all duration-300 shrink-0 ${activeCategory === cat.id
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        {CATEGORY_OPTIONS[activeCategory].map(option => (
                          <button
                            ...
                            className={`h-12 rounded-xl text-[10px] font-black uppercase tracking-tighter border transition-all ${moveSize === option
