      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="mt-20 p-6 md:p-10 rounded-3xl md:rounded-[2.5rem] bg-primary/5 border border-primary/10">
          ...
          <div className="columns-1 md:columns-2 gap-12 text-sm text-muted-foreground leading-relaxed font-medium">
            <p className="mb-4">
              As the leading <strong className="text-foreground">Packers and Movers in Nagpur</strong>, Sunita Cargo offers a wide range of services including house shifting, office relocation, and industrial moves. We dominate local shifting in <strong className="text-foreground">Nagpur (including Wadi, Dharampeth, Manish Nagar, Narendra Nagar, Besa, and Beltarodi) and nearby districts like Wardha, Bhandara, Amravati, and Chandrapur</strong>, while providing dedicated long-distance transport to Mumbai, Pune, Bangalore, and Delhi NCR. Our team is trained in scientific packing methods, ensuring your furniture and electronics stay safe during thousands of kilometers of transit.
            </p>
            <p>
